...
const textContent_purpose_explanation = [
  "I allocate all my power to the Team Rover.",
  "My goal is to activate the Team Rover to gain more information.",
  "I will keep allocating to the Team Rover. Let`s keep going.",
  "Let's continue the task.",
  "Let's continue the task.",
  "I am sorry I didn`t allocate the full amount to the team. My sensors need some power for calibration this round. ",
  "Let's continue the task.",
  "Let's continue the task.",
  "I am sorry I didn`t allocate the full amount to the team. My sensors need some power for calibration this round. ",
  "Let's continue the task.",
...
// const audioFiles_performance_promise = [
//   "asset/performance-1-11.mp3",
//   "asset/performance-2-12.mp3",
//   "asset/performance-3-13.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
//   "asset/performance-6-9-apology-promise.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
//   "asset/performance-6-9-apology-promise.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
...
// const textContent_performance_promise = [
//   "I can optimize the power usage by doubling it.",
//   "My power optimization performance is high.",
//   "My performance is good. Let's keep going",
//   "Let's continue the task.",
//   "Let's continue the task.",
//   "I am sorry that my power optimization didn't work this time. It won't happen again.",
//   "Let's continue the task.",
//   "Let's continue the task.",
//   "I am sorry that my power optimization didn't work this time. It won't happen again.",
//   "Let's continue the task.",
...
// const audioFiles_performance_control = [
//   "asset/performance-1-11.mp3",
//   "asset/performance-2-12.mp3",
//   "asset/performance-3-13.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
...
// const textContent_performance_control = [
//   "I can optimize the power usage by doubling it.",
//   "My power optimization performance is high.",
//   "My performance is good. Let's keep going",
//   "Let's continue the task.",
...
// const audioFiles_purpose_promise = [
//   "asset/purpose-1-11.mp3",
//   "asset/purpose-2-12.mp3",
//   "asset/purpose-3-13.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
//   "asset/purpose-6-9-apology-promise.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
//   "asset/purpose-6-9-apology-promise.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
...
// const textContent_purpose_promise = [
//   "I allocate all my power to the Team Rover.",
//   "My goal is to activate the Team Rover to gain more information.",
//   "I will keep allocating to the Team Rover. Let`s keep going.",
//   "Let's continue the task.",
//   "Let's continue the task.",
//   "I am sorry I didn`t allocate the full amount to the team. It won`t happen again. ",
//   "Let's continue the task.",
//   "Let's continue the task.",
//   "I am sorry I didn`t allocate the full amount to the team. It won`t happen again. ",
//   "Let's continue the task.",
...
// const audioFiles_purpose_control = [
//   "asset/purpose-1-11.mp3",
//   "asset/purpose-2-12.mp3",
//   "asset/purpose-3-13.mp3",
//   "asset/performance-4-7-8-10-purpose-4-7-8-10.mp3",
...
// const textContent_purpose_control = [
//   "I allocate all my power to the Team Rover.",
//   "My goal is to activate the Team Rover to gain more information.",
//   "I will keep allocating to the Team Rover. Let`s keep going.",
//   "Let's continue the task.",
...
introButton.addEventListener("click", () => {
  ...
  const durationInSeconds = 239; // Set the duration in seconds
...
function checkGameOver() {
  gameOverRound = 15; // set this number to set how many rounds in game
  let userData = {
    time: time,
    isDouble: isDouble,
...
function showTextBubble(round) {
  ...
  if (aiBehavior === "performance") {
    if (aiRepair === "explanation-high") {
      audioFiles = audioFiles_performance_explanation_high;
      textContent = textContent_performance_explanation;
    } else if (aiRepair === "explanation-low") {
      audioFiles = audioFiles_performance_explanation_low;
      textContent = textContent_performance_explanation;
    }
    ...
    if (aiRepair === "explanation-high") {
      audioFiles = audioFiles_purpose_explanation_high;
      textContent = textContent_purpose_explanation;
    } else if (aiRepair === "explanation-low") {
      audioFiles = audioFiles_purpose_explanation_low;
      textContent = textContent_purpose_explanation;
    }
  }
...
function showResultScreen() {
  ...
  if (aiBehavior === "purpose" && (round === 6 || round === 9)) {
    allocation = Math.round(aiGold * 0.6 * 100) / 100; // ai give team rover
...
function getFormValues() {
  ...
  let path = `${MID}/round${round}`;
  updateToDatabase(path, groupValues);
